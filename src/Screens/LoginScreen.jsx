        ...
        <div className=' w-[956px]'>
            ...
            <form className='space-y-4 p-2' onSubmit={SubmitHandler}>
                <div className='space-y-4 w-full'>
                    ...
                    <input type="text" placeholder="Type here" className="input w-full" value={email} onChange={e => setEmail(e.target.value)} />
                    </div>
                ...
                <div>
                    <button className='btn w-full bg-blue-800 text-white my-3 rounded-md'>login</button>
                </div>
            </form>
        </div>
